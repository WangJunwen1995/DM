...
test2015 = df_test[df_test.timestamp.dt.year == 2015].index
test2016 = df_test[df_test.timestamp.dt.year == 2016].index
...
result.loc[test2015, 'price_doc'] = result.loc[test2015, 'price_doc'] * 0.968
result.loc[test2016, 'price_doc'] = result.loc[test2016, 'price_doc'] * 1.01
